...
class ElasticsearchUtilitiesTests(unittest.TestCase):
    ...
    def test_write_to_es(self):
        ...
        data = [
            {"UPRN": 1, "PropertyID": 4, "Addr1": "Aardvark", "geocode": [53.20710, -2.89310]},
    ...
    def test_update_to_es(self):
        ...
        check_updated_query = {"query": {"constant_score": {"filter": {"term": {"UPRN": 3}}}}}
        ...
        data = [
            {
                ...
                "PropertyID": 4,
                "Addr1": "Aardvark",
                "geocode": {"lat": 53.20710, "lon": -2.89310},
            },
            {
                "UPRN": 2,
                "PropertyID": 5,
            ...
            },
            {
                ...
                "PropertyID": 6,
                "Addr1": "Camel",
                "geocode": {"lat": 53.40710, "lon": -2.89310},
            },
        ]
        write_to_db(data, es_config, self.es_fields, table="testrecord")
